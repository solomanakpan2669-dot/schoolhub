...
function viewTeacher(id) {
    ...
    // Create the teacher profile modal automatically
    // if it does not already exist in index.html.
    if (!modal) {
    ...
    const ageElement =
        document.getElementById("teacherProfileAge");

    const subjectElement =
        document.getElementById("teacherProfileSubject");

    const emailElement =
        document.getElementById("teacherProfileEmail");

    const avatarElement =
        document.getElementById("teacherProfileAvatar");
